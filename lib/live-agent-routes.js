...
function mountLiveAgentRoutes(app) {
  ...
  router.get('/knowledge/search', requireAgentSession, (req, res) => {
    setNoCache(res);
  ...
  router.put('/settings', requireAgentSession, (req, res) => {
    ...
    try {
      ...
      const settings = store.saveSettings(merged);
      res.json({
        ok: true,
        settings,
        departments: departmentsForApi(settings.departments),
  ...
  router.put('/departments/:id', requireAgentSession, (req, res) => {
    setNoCache(res);
    try {
      const settings = store.loadSettings();
      settings.departments = settings.departments || [];
  ...
  router.delete('/departments/:id', requireAgentSession, (req, res) => {
    setNoCache(res);
    try {
