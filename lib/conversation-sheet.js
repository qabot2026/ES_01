...
/** Dialogflow open_form `tag` (e.g. resume → Resume) for Sheets and documents UI. */
...
function documentForSheet(meta) {
  return documentDisplay.documentNamesFromMeta(meta || {});
}
...
function buildRowValues(doc) {
  ...
  return [
    ...
    formatUploadTag(meta.tag || meta.upload_tag),
