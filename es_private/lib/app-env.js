...
module.exports = {
  ...
  GCS_UPLOAD_PREFIX: str('GCS_UPLOAD_PREFIX', 'uploads'),
  GCS_SIGNED_URL_DAYS: num('GCS_SIGNED_URL_DAYS', 7),
  GCS_DATA_SYNC_PREFIX: str('GCS_DATA_SYNC_PREFIX', 'data-sync'),
  ...
  APPEARANCE_MENU_ICON_OBJECT: str(
    ...
    'fromclient/appearence-logo.png'
  ),

  NODE_ENV: str('NODE_ENV'),

  META_APP_SECRET: str('META_APP_SECRET'),
  META_VERIFY_TOKEN: str('META_VERIFY_TOKEN'),
